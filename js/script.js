...
let _ame = {
	...
	locationError: function _ameLocationError(e) {
		switch (e.code) {
			case 1:
				var m = 'user denied permision, please allow app to access your location or enter your location manually.';
				break;
			case 2:
				console.log('POSITION_UNAVAILABLE');
				var m = 'location is unavailable, make sure you\'re connected to the internet. if the problem presists, enter your location manually or try again later.';
				break;
			case 3:
				var m = 'browser is taking too long to respond, please enter your location manually or try again later.';
				break;
		}
	...
	input: {
		...
		cities: [],
		matched: [],
		load: function _ameInputSearch(r) {
			$.ajax({
				url: 'js/sorted.json',
				dataType: 'json',
